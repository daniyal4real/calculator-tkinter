...
tk.Button(window, text="C1", font=BUTTON_FONT, fg="black", bg="white", width=3, height=1, command=lambda: display.delete(len(display.get())-1)).grid(row=1, column=2)
...
# Fifth Row
tk.Button(window, text="CE", font=BUTTON_FONT, fg="black", bg="white", width=3, height=1, command=lambda: input_text.set("")).grid(row=5, column=0)
